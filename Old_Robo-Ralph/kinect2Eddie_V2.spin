'This accepts a sequence of: receive character, receive data, flush, and repeat.



'TO DO:
' RECIEVE X, Y, AND Z DATA FROM PROCESSING.
...
repeat
  ...
  if CharIn == "z"                      '1700 is approximately 4' from kinect. Larger = farther.
