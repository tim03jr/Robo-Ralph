...
long DataLR
word DataIn
long EncoderPin_Left
long EncoderPin_Right
long Desired_Width
long New_Width
...
if DataIn == "y"
  repeat until DataIn <> "y" or range0 < distance or range1 < distance or range2 < distance                    'This repeat loop keeps the motors going forward until the botton is switched to manual.    
...
PUB Encoder_Read      'The input pin has a 1.65V threshold
