'This version: Auto mode has EL-tape blinking when going forward. EL-tape only blinks when going forward.
              'Servo pans back and forth
...
XB_Tx = 12 ' XBee DIN      'This is set to pin 12 because pin 12 is not an I/O pin(We are not using DIN of the XBee)                                        |
XB_Baud = 9600'                                                                                                                                             |
'___________________________________________________________________________________________________________________________________________________________|
